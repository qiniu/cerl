...
***		CMD5Checksum.h: interface for the CMD5Checksum class.
...
#if !defined(AFX_CMD5Checksum_H__2BC7928E_4C15_11D3_B2EE_A4A60E20D2C3__INCLUDED_)
#define AFX_CMD5Checksum_H__2BC7928E_4C15_11D3_B2EE_A4A60E20D2C3__INCLUDED_
...
public:
	...
	//--> by xushiweizh@gmail.com: require MFC, so I don't need.
	// I change interface as follow:
	friend STDMETHODIMP_(void) GetCMD5Checksum(
		IN const BYTE* pBuf, IN UINT nLength, OUT BYTE nChecksum[16]);
	
//protected:
//--> by xushiweizh@gmail.com: I public constructor and Update, Final method.
public:
	...
	void Update(const BYTE* Input, size_t nInputLen);
	//BYTE* Final();
...
protected:
	...
	//utility functions
	inline void DWordToByte(BYTE* Output, const DWORD* Input, UINT nLength);
