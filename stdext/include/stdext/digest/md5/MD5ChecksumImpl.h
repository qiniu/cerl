...
*****************************************************************************************/
/*
void CMD5Checksum::GetMD5(IN const BYTE* pBuf, IN UINT nLength, OUT BYTE nChecksum[16])
{
	//calculate and return the checksum
	CMD5Checksum MD5Checksum;
	MD5Checksum.Update( pBuf, nLength );
	MD5Checksum.Final( nChecksum );
}
*/
...
*****************************************************************************************/
inline
void CMD5Checksum::Update(const BYTE* Input, size_t InputLen)
{
	const UINT nInputLen = (UINT)InputLen;
...
*****************************************************************************************/
inline
//BYTE* CMD5Checksum::Final()
void CMD5Checksum::Final(OUT BYTE nChecksum[16])
{
	...
	DWordToByte( nChecksum, m_lMD5, 16 );
	
/* --> by xushiweizh@gmail.com: comment
