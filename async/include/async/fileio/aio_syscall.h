/* modified from /usr/include/libaio.h
 *
 ...
 */
#ifndef ASYNC_FILEIO_AIO_SYSCALL_H
#define ASYNC_FILEIO_AIO_SYSCALL_H
...
{
	return syscall(SYS_io_setup, maxevents, ctxp);
}
...
{
	return syscall(SYS_io_cancel, ctx, iocb, evt);
}
...
#endif /* ASYNC_FILEIO_AIO_SYSCALL_H */
