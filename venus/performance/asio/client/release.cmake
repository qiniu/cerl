...
set(CMAKE_CXX_FLAGS "-g0 -O3 -static")
#可执行文件名称
ADD_EXECUTABLE( client ${DIR_SRCS})

#连接用的库名称	
target_link_libraries( client boost_system boost_thread pthread )
...
add_custom_target(check
  COMMAND  valgrind --leak-check=full --show-reachable=yes ./client
